...
::%_SILENT_%set PATH=%ChocolateyInstall%\bin;%PATH%
%_SILENT_%where choco > NUL 2>&1 || set PATH=%ProgramData%\chocolatey\bin;%PATH%
%_SILENT_%title Installing .NET framework 4.5. Please wait...
%_SILENT_%echo ==^> Installing .NET 4.5.
%_SILENT_%set INSTALL_COMMAND=choco install -y dotnet4.5
